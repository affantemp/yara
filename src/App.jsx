...
export default function Page() {
  ...
  useEffect(() => {
    if (yesPressed && noCount < 4 && !popupShown) {
      Swal.fire({
        title: "I love you sooo Much!!!❤️, You’ve stolen my heart completely!!! 🥰💖 But stfu and click no a bunch of times then click yes for your reward or my hard work will be wasted. 🥰✨",
        showClass: {
          popup: `
            animate__animated
            animate__fadeInUp
        ...
        {yesPressed && noCount>3 ? (
          <>
            <img
              ...
              alt="Yes Response"
            />
            <div className="text-4xl md:text-6xl font-bold my-2" style={{ fontFamily: "Charm, serif", fontWeight: "700", fontStyle: "normal" }}>I Love You Yaraaa!!!</div>
